...
translators_metadata = [
    ...
    },
    {
        ...
        "h1": "Free Online Navajo Translator – Modern English to Diné Bizaad",
    ...
    },
    {
        ...
        "h1": "Free Online Old Norse Translator – English to Viking Runes & Futhark",
    ...
    },
    {
        ...
        "h1": "Free Online Ancient Greek Translator – Modern English to Classical Greek Script",
    ...
    },
    {
        ...
        "h1": "Free Online Shakespearean Translator – Modern English to Elizabethan",
    ...
    },
    {
        ...
        <table style="width:100%; border-collapse:collapse; margin-top:1rem; margin-bottom:1.5rem; font-size:0.88rem;">
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Underworld / Netherworld</td>
                    <td style="padding:0.5rem;">Kur-nu-gi4</td>
                    <td style="padding:0.5rem; font-size:1.2rem;">𒆳<ctrl42></td>
                    <td style="padding:0.5rem;">/kur.nu.gi/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Plow / Agriculture Tool</td>
                    <td style="padding:0.5rem;">Apin</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/a.pin/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Boat / Sailing Vessel</td>
                    <td style="padding:0.5rem;">Ma2</td>
                    <td style="padding:0.5rem; font-size:1.2rem;">𒈣</td>
                    <td style="padding:0.5rem;">/ma/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Priest / Scholar</td>
                    <td style="padding:0.5rem;">Gudu4 / Gala</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/gu.du/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Milk / Sacred Offering</td>
                    <td style="padding:0.5rem;">Ga</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/ga/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Honey / Nectar</td>
                    <td style="padding:0.5rem;">Lal3</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/lal/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Wine / Vintage</td>
                    <td style="padding:0.5rem;">Geshtin</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/geʃ.tin/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Copper / Bronze Ore</td>
                    <td style="padding:0.5rem;">Urudu</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/u.ru.du/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Cedar / Sacred Wood</td>
                    <td style="padding:0.5rem;">Erin</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/e.rin/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Field / Territory</td>
                    <td style="padding:0.5rem;">A-sha3</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/a.ʃa/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Hand / Strength</td>
                    <td style="padding:0.5rem;">Shu</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/ʃu/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Eye / Vision</td>
                    <td style="padding:0.5rem;">Igi</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/i.gi/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Heart / Intellect</td>
                    <td style="padding:0.5rem;">Sha3</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/ʃa/</td>
                </tr>
                <tr style="border-bottom:1px solid rgba(255,255,255,0.05);">
                    <td style="padding:0.5rem;">Name / Renown</td>
                    <td style="padding:0.5rem;">Mu</td>
                    <td style="padding:0.5rem; font-size:1.2rem;"><ctrl42></td>
                    <td style="padding:0.5rem;">/mu/</td>
                </tr>
            </tbody>
        ...
        <h3 style="font-family:'Cinzel', serif; color:var(--accent); font-size:1.1rem; margin-top:1.5rem; margin-bottom:0.5rem;">Step-by-Step Guide: How to Translate and Export Cuneiform Stencils</h3>
        <p>Follow these steps to generate high-definition vector stencils for jewelry engravers or tattoo artists:</p>
        <ol style="margin-left:1.5rem; margin-top:0.5rem;">
            <li><strong>Type English Words:</strong> Enter words like <em>king, lord, love, star, or water</em> in the input box above.</li>
            <li><strong>Review Cuneiform Symbols:</strong> The output box will instantly render the corresponding cuneiform glyphs or phonetic syllabary transliterations.</li>
            <li><strong>Customize Canvas Parameters:</strong> Select your preferred font size (Small, Medium, Large) and adjust text and background colors to test contrast.</li>
            <li><strong>Export PNG Stencil:</strong> Check 'Transparent PNG' and click the 'Export PNG' button to download a crisp 300 DPI layout stencil ready for laser engraving.</li>
        </ol>
        """,
        ...
        "faq": [
            ...
            {
                "q": "Can I use this Sumerian Cuneiform Translator for tattoo stencils or wedding ring engravings?",
                "a": "Absolutely! Thousands of users generate custom cuneiform stencils for historical tattoos or personalized ring inscriptions. Using our Interactive Exporter ensures exact symbol proportions."
            },
            {
